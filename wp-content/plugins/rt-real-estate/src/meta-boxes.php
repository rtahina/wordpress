...
class MetaBoxes {
    ...
    public function render_meta_box_content( $post ) {
        ...
        $city_controller = new \RTRealEstate\Controllers\CityController();
        ...
        <select id="property_city_meta_box" name="property_city">
            ...
            <?php foreach ( $cities['cities'] as $city ) : ?>
                <option value="<?php echo $city['ID']; ?>"<?php echo ( $city['ID'] == $value ) ? ' selected="selected"' : ''; ?>><?php echo $city['name']; ?></option>
            <?php endforeach; ?>
        </select>
        <?php
    }
